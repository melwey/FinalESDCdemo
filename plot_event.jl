...
# colormap
colormap = [(:grey9, 0.02), (:bluereds, 0.8)]
...
# subset around (20,40,2321)
# c = input_burnt[x = 20 .. 20.1, y = 39.9 .. 40, time = tempo[2310] .. tempo[2330]]
c = input_burnt[x = -8.07 .. -8, y = 39.93 .. 40, time = tempo[4200] .. tempo[4220]]
...
# replace outside event by 0.5
replace!(x -> x < 1.0 ? 0.5 : 1.0, view(data_cut,:,:,7))
data_cut[:,:,7]
